...
export function useDashboardData() {
    ...
    useEffect(() => {
        ...
        if (!generalMetrics.isLoading && !averagePerformance.isLoading && !revenueByDate.isLoading && !revenueBySource.isLoading) {
            setIsLoading(false);
        }

    }, [generalMetrics.isLoading, averagePerformance.isLoading, revenueByDate.isLoading, revenueBySource.isLoading])
